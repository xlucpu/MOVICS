...
* [4. MOVICS Pipeline](#Section.4)
  ...
  * [4.2 Steps of Pipeline](#Section.4.2)
    ...
    * [4.2.3 RUN Module](#Section.4.2.3)
      ...
      * [5) run partition around medoids classifier](#Section.4.2.3.5)
      * [6) run consistency evaluation using Kappa statistics](#Section.4.2.3.6)
...
It is essential that you have R 4.0.2 or above already installed on your computer or server. MOVICS is a pipeline that utilizes many other R packages that are currently available from CRAN and Bioconductor. For all of the steps of the pipeline to work, make sure that you have upgraded Bioconductor to newest version (BiocManager v3.11).
...
#### <a id="Section.4.2.3.5" style="color:#159957;">5) run partition around medoids classifier</a>
...
#### <a id="Section.4.2.3.5" style="color:#159957;">6) run consistency evaluation using Kappa statistics</a>
...
```{r, fig.show = "hold", out.width = "33.3%", fig.align = "default", fig.width=10, fig.height=3.5, fig.cap="Figure 19. Consistency heatmap using Kappa statistics.", eval=TRUE}
...
```{r, fig.align="center", fig.width=6, fig.height=7, fig.cap="Figure 20. Kaplan-Meier survival curve of PAM50 subtypes of breast cancer with pseudo input in TCGA-BRCA cohort.", eval=TRUE}
# survival comparison
...
17. Tibshirani R, Hastie T, Narasimhan B and Chu G (2002). Diagnosis of multiple cancer types by shrunken centroids of gene expression. Proc Natl Acad Sci, 99,6567–6572.
