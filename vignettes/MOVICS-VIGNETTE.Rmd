...
load(system.file("extdata", "brca.tcga.rda", package = "MOVICS", mustWork = TRUE))
load(system.file("extdata", "brca.yau.rda",  package = "MOVICS", mustWork = TRUE))
```
